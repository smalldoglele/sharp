...
public class ResultEntity<T> {
    ...
    public interface Builder {
        ...
        <T> ResultEntity<T> result(T result, String message);
    }
    ...
    private static class ResultBuilder implements Builder {
        ...
        @Override
        public <T> ResultEntity<T> result(T result, String message) {
            return new ResultEntity<>(status, message, result, spare);
        }
    }
    ...
    public static <T> ResultEntity<T> bad(T result,String message) {
        return status(ResultEntity.BAD).result(result,message);
    }
}